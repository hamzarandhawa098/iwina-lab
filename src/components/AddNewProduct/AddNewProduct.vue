      ...
      <div class="h-[654px]">
        ...
        <div class="flex flex-col lg:flex-row gap-8 mt-6">
          <input
            ...
            v-model="form.subject"
            type="text"
            class="lg:[515px] px-3 py-[10px] rounded-[8px] border border-Ticket-input font-nunito font-normal text-[14px] leading-[20px] tracking-[-0.05px] text-Ticket-placeholder"
            :placeholder="price"
          />
        ...
        <div class="mt-6">
          <textarea
            ...
            rows="6"
            class="lg:w-[1063px] px-3 py-[10px] rounded-[8px] border border-Ticket-input font-nunito font-normal text-[14px] leading-[20px] tracking-[-0.05px] text-Ticket-placeholder"
