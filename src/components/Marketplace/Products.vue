<template>
  <div class="lg:p-6 bg-white border border-border-color rounded-lg shadow">
    ...
    <div class="table-container lg:overflow-hidden">
      <Table class="mt-[18px] w-[350px] lg:w-[689px] h-[260px] overflow-auto lg:overflow-hidden">
        <template #header>
